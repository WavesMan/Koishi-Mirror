...
func (l *Logger) Trace(category, msg string, fields map[string]interface{}) { l.log(0, "trace", category, msg, fields) }
func (l *Logger) Debug(category, msg string, fields map[string]interface{}) { l.log(1, "debug", category, msg, fields) }
